...
> **플랫폼은 아직 미확정이다.** 이 문서는 Atlas Cloud를 택할 경우의 사용법이며,
> 선택 자체는 `Seedance_생성예산_2026-09-13.pdf` 와 `Seedance_플랫폼_선정_3주_rev2_*.pdf` 를 볼 것.
> 업스케일은 Topaz 로컬로 하기로 했으므로 Atlas 업스케일러 관련 서술은 참고용이다.
